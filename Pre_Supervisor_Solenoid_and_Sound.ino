...
/* This is the original script written before "Show Supervisor" controll flow was deemed necessary to this project. For reference only!!
    Please see other files updated to fit into Supervisor control scheme */
